    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[95%] md:max-w-2xl lg:max-w-3xl max-h-[90vh] overflow-y-auto">
        ...
        <form onSubmit={handleSubmit} className="space-y-4 py-2 px-1">
          ...
          {/* Message */}
          <div className="space-y-2">
            <Label htmlFor="message">Tell us about your customer support needs</Label>
            <Textarea
              id="message"
              name="message"
              placeholder="Describe your current challenges, team size, and what kind of customer support you're looking for."
          ...
          <div className="flex justify-end pt-2">
            <Button 
              type="submit" 
              disabled={isPending}
              className="w-full sm:w-auto px-6 py-2.5 text-base font-medium rounded-lg bg-blue-600 text-white hover:bg-blue-700 transition-colors duration-200"
            >
              {isPending ? (
                <>
